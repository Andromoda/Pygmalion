...
namespace hook_post_oreo
{
    ...
    { HOOK_BODY_INT(NativeGetResourceValue,env,clazz,getHookClz(env),ptr,resid,density,typed_value,resolve_references); }
    ...
    { HOOK_BODY_INT(NativeThemeGetAttributeValue,env,clazz,getHookClz(env),ptr,theme_ptr,resid,typed_value,resolve_references); }
    ...
    { HOOK_BODY_VOID(NativeApplyStyle,env,clazz,getHookClz(env),ptr,theme_ptr,def_style_attr,def_style_resid,xml_parser_ptr,java_attrs,out_values_ptr,out_indices_ptr); }
    ...
    { HOOK_BODY_BOOL(NativeResolveAttrs,env,clazz,getHookClz(env),ptr,theme_ptr,def_style_attr,def_style_resid,java_values,java_attrs,out_java_values,out_java_indices); }
    ...
    { HOOK_BODY_BOOL(NativeRetrieveAttributes,env,clazz,getHookClz(env),ptr,xml_parser_ptr,java_attrs,out_java_values,out_java_indices); }
}
