...
способ осуществить мою задумку хукинга `AssetManager`. Помимо этого я не хочу использовать известные 
...
(пр. изменение акцентных цветов) без исходного кода приложения.
