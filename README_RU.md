...
обратная совметимость с будующими обновлениями не гарантируется. 

## Описание проекта
Я делаю эту библиотеку для своих текущих и будующих проектов. Одна из основных целей это возможность
